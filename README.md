...
Prepare templates with cloud init (one of them needs to have addistional disk for osd)

Additional: create user for creating cluster would be helpful (Script needs ssh key which is generated by prepare-settings.sh)
